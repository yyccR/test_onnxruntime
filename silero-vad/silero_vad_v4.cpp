...
std::string silero_vad_onnxruntime_model_path;
...
int window_size_samples = 64 * sr_per_ms;

int min_speech_samples = sr_per_ms * 64;
int speech_pad_samples = sr_per_ms * 64;
...
void predict(const std::vector<float> &data) {
    ...
    Ort::Value h_ort = Ort::Value::CreateTensor<float>(
            allocator_info, _h.data(), _h.size(), hc_node_dims, 3);
    Ort::Value c_ort = Ort::Value::CreateTensor<float>(
            allocator_info, _c.data(), _c.size(), hc_node_dims, 3);
...
void vad()
{
    ...
    std::string model_path = "/Users/yang/CLionProjects/test_onnxruntime/silero-vad/silero_vad_v4.onnx";
//    std::string model_path = "/Users/yang/Downloads/silero_vad.onnx";
